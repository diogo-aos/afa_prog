...
- VSCode [instruções](instalar_compilador_vscode_2.htm){target="_blank"}
- Code::BLocks [instruções](/pdf/P01%20-%20Code%20Blocks.pdf){target="_blank"}

# Notas

Os exercícios denominados "King ..." são retirados do livro 

["C Programming: A Modern Approach, 2nd Edition" do K. N. King](http://knking.com/books/c2/index.html){target="_blank"}

# 2 Fundamentos
<!-- .slide: data-background="Coral" id="2_exercicios" -->

[Slides da matéria](../lectures/2_fundamentals.qmd)
...
[Slides da matéria](../lectures/3_formated_io.qmd)
