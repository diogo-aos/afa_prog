...
7. [Tipos básicos do C](#/7_basic_types)
  - [Slides](markdown/7_basic_types.html)
8. Funções
...
9. Arrays
  ...
  - Videos
    ...
    3. [Demo exercício salários - 14min](https://www.loom.com/share/2583c4a69d0141de8f1a1271ad92c9e1)
      a. 00:00 explicar enunciado
      b. 01:10 inicio da solução
      c. 02:28 função pedir salarios
      d. 04:05 função para mostrar salários
      e. 07:25 função para somar salários
      f. 9:30 função para a média dos salários
      g. 11:56 utilizador indica quantos salários quer introduzir
...
15. [Dynamic Data Structures](markdown/15_data_structs_slides.html)
16. [Extra](#/extra)
17. [Exercícios](exercicios.html)
