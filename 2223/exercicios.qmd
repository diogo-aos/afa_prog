...
[Slides da matéria](https://www.diogoaos.com/slides/prog/#/2_fundamentals)
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/#/3_formated_io)
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/#/4_expressions)
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/pdf/03_testes_condicoes.pptx.pdf)
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/#/ciclos)
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/#/7_basic_types)
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/#/funcoes)
...
- Além da função `poli2_intervalo`, implementa a função `poli2_ponto` que recebe os coeficientes do polinómio, o ponto `x` a avaliar e devolve o resultado desse polinómio no ponto recebido (ver exercício [King 9.6](#king-9.6.-polinómio))
- Valores introduzidos pelo utilizador (coeficiente, limite inferior, superior, e nº de pontos) são pedidos na função main.
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/#/array)
...
- O perceptron recebe um vetor de inteiros _x_ (o input do perceptron) e um vetor de reais _w_ (os pesos de cada input e o bias).
- O vetor _x_ tem tamanho _n_ e o vetor _w_ tem tamanho _n+1_.
- O perceptron calcula o produto escalar de _x_ e _w_ e devolve 1 se o resultado for positivo e 0 se for negativo ou zero.
- O último elemento do vetor _w_ é o bias.
...
![Diagrama do Perceptron](https://www.nomidl.com/wp-content/uploads/2022/04/image-5.png)
...
![Diagrama de uma rede neuronal](https://www.nomidl.com/wp-content/uploads/2022/04/image-6.png)
...
- Escreve uma função que recebe um vetor de reais _x_ (o input da rede) e uma matriz de reais _w_ (os pesos de cada perceptron e o bias).
- O vetor _x_ tem tamanho _n_ e a matriz _w_ tem _m_ linhas e _n+1_ colunas.
- Cada linha da matriz _w_ corresponde aos pesos de um perceptron, portanto a matriz tem _m_ perceptrons.
...
- O cabeçalho da função é o seguinte:
  ...
  ```
- A função calcula o output de cada perceptron e guarda-o no vetor _output_.
- O output de cada perceptron é calculado da mesma forma que no [exercício anterior](#afa-9.5.-redes-neuronais-perceptron).
- Por exemplo, para um input de 3 elementos e uma camada de 4 perceptrons, a função recebe um vetor _x_ de tamanho 3, uma matriz _w_ de tamanho 4x4 e um vetor _output_ de tamanho 4. O output de cada perceptron seria calculado da seguinte forma:
  ```c
...
- Usa a função `camada_perceptron` do [exercício anterior](#afa-9.6.-redes-neuronais-combinar-perceptrons) para implementar a rede neuronal.


# 10 Exercícios Strings
<!-- .slide: data-background="Coral" id="10_strings_exercicios" -->

[Slides da matéria](https://www.diogoaos.com/slides/prog/#/string)
...
Dica:
- Usa a função strcmp da biblioteca string.h, que recebe 2 strings (s1 e s2) e devolve 0 se s1 e s2 forem iguais, devolve um valor negativo se o primeiro caracter diferente de s1 for inferior ao primeiro carater diferente de s2, ou um valor positivo se o primeiro carater diferente de s1 for superior ao primeiro carater diferente de s2.
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/#/pointer)


# 12 Exercícios Struct
<!-- .slide: data-background="Coral" id="12_struct_exercicios" -->

[Slides da matéria](https://www.diogoaos.com/slides/prog/#/struct)
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/#/files)
...
- Considera a seguinte estrutura
  ...
  ```
- O ficheiro [alunos.bin](exercicios_assets/a_13_12/alunos.bin) contém vários Aluno.
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/#/memory)
...
- O teu objetivo será criar uma função que recebe uma imagem (vector de _unsigned char_ com 3 dimensões) e vai criar uma cópia da imagem original, mas com partes da imagem escondida.
...
[Slides da matéria](https://www.diogoaos.com/slides/prog/markdown/15_data_structs_slides.html#/title-slide)
